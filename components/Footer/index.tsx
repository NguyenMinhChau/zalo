					...
					<div className="-mx-4 flex flex-wrap">
						<div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
							<div className="mb-12 max-w-[360px] lg:mb-16">
								<Link
									href="/"
									className="mb-8 inline-block w-48"
								>
									{/* <Image
										src={LogoLight}
										alt="logo"
								...
								<p className="mb-3 text-left text-base font-medium leading-relaxed text-body-color">
									DISCOVER | MEET | DISCUSS | ENGAGE
								</p>
								<p className="mb-9 text-left text-base font-medium leading-relaxed text-body-color">
