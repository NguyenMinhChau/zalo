						...
						<div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
							<div className="mb-12 max-w-[360px] lg:mb-16">
								...
								<p className="mb-9 text-justify text-base font-medium leading-relaxed text-body-color">
									...
									adipisicing elit. Id quaerat totam dolores
									eveniet, nihil officia et dolor, expedita
									modi accusamus error? Atque labore dolor
									repellat corporis? Quas porro assumenda
									ratione?
								</p>
