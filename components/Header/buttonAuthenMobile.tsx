...
const ButtonAuthenMobile = () => {
	...
	return (
		<button
			...
			className={`bg-gray-2 lg:hidden md:hidden dark:bg-dark-bg flex h-9 cursor-pointer items-center justify-center rounded-full ${
				sticky ? 'text-white' : 'text-[#000]'
			}  md:h-14 md:w-14 mr-2`}
		>
			{!currentUser ? (
				<>
