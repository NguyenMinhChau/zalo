									...
									<div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
										<div className="mb-4 sm:mb-0">
											<label
												...
												className="flex cursor-pointer select-none items-center text-sm font-medium text-[#000]"
											>
												<div className="relative">
													<input
														...
														className="sr-only"
													/>
													<div className="box mr-4 flex h-5 w-5 items-center justify-center rounded border border-[#000] border-opacity-20 dark:border-opacity-10">
