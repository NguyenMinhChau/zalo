								...
								<form>
									...
									<div className="mb-8 flex">
										<label
											...
											className="flex cursor-pointer select-none text-sm font-medium text-[#000]"
										>
											<div className="relative">
												<input
													...
													className="sr-only"
												/>
												<div className="box mr-4 mt-1 flex h-5 w-5 items-center justify-center rounded border border-[#000] border-opacity-20 dark:border-opacity-10">
